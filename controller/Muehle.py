...
def isGameFinished(self) -> (bool, Player):
	if self.activePlayer.startTokenList == 0 and len(
			self.activePlayer.tokenList) < 3:  # active player has less than 3 tokens -> other player wins
		return True, self.activePlayer
